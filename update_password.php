...
<div class="navbar">
  ...
  <a style="float: right;" href="search_resources.php" class="home" value="home"><i class="fa fa-home" >logout</i></a>
...
if (empty($_POST["passwordConfirm"])) {
    ...
    if(strcmp($password ,$passwordConfirm)== 0){
      $sql = " SELECT PASSWORD FROM patron WHERE  Passport_Number = '$PassportNumber' ";
      $result = $conn->query($sql) or die($conn->error);
     $row = $result->fetch_assoc();
      if(strcmp($row['PASSWORD'] ,$passwordConfirm)==0){
        header("Location:save_password.php?password=correct");
        exit();
      } else{
          header("Location:save_password.php?password=wrongpassword");
      }
    }
  }
...
?>
  ...
  <div class="container">
    ...
    <hr>
      <p class="error"> <?php if(isset($incorrectPassword)) echo $incorrectPassword; ?></p><br>
