...
<div class="navbar">
  ...
  <a style="float: right;"  href="librarian_forgotten_password.php" >Reset Password</a>
...
if(empty($_POST["email"])) {
  $emailErr = "email required";
    ...
    if ($quary===false){
        ...
        if(  $resultCheck > 1){
          header("Location: librarian_forgotten_password.php?error=invalidEmail");
        } else{
          ...
          if ($quary===false){
                ...
                $mail -> Body = "
                                ...
                                Enugu state library";
                                if($mail ->send())
                                header("Location: librarian_forgotten_password.php?email=sent");
                                else
